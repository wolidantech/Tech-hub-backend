-- =====================================================================
-- WOLI DAN TECH HUB
-- Migration 005: Seed data — categories, platform settings (bank
-- details) and the initial course catalog (all NGN 5,000.00).
-- Prices/bank details are stored as DATA so admins can change them
-- from the dashboard without touching source code.
-- =====================================================================

-- -----------------------------------------------------------------
-- Platform settings — manual bank transfer details
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------
-- Initial courses (NGN 5,000.00 each)
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------
-- Example curriculum: modules for "Video Editing with CapCut"
-- (as specified — admins manage/add lessons from the dashboard)
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------
-- Sample first lesson so the course structure is demonstrably usable
-- (free preview — a real lesson, marked published)
-- -----------------------------------------------------------------
